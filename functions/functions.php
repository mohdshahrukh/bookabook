	...
	global $db;
	    ...
	    if(!isset($_GET['cat'])){
				...
				while($row_books=mysqli_fetch_array($run_books))
				{
				    ...
				    <p><b>Price: Rs. $book_cost </b></p><br>
					
					
					<a href=details.php?book_id=$book_id style='float:left; color: red;'>Details</a>
				    
					<a href=index.php?add_cart=$book_id><button style='float:right; text-decoration:none color: green;'>Add to Cart</a>

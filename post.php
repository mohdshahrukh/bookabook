...
<table  width="800px" height="650px"  border="1" align="center" bgcolor="maroon" >
...
<td><textarea name="book_desc" cols="50" rows="5" placeholder="WRITE KEYWORDS WHICH HELPS BUYER TO SEARCH YOUR BOOK eg(book name, author name etc.)."></textarea></td>
</tr>
...
if(isset($_POST['sell']))
{
	...
	if($book_title=='' OR $book_author=='' OR $book_cat=='' OR $book_cost=='' OR $book_desc=='' OR $book_keywords=='' OR $book_img1=='' OR $book_img2=='')
	{
	...
	{   
		...
		$insert_book = "insert into books (cat_id,date,book_title,book_author,book_img1,book_img2,book_cost,book_desc,s_name,s_phone,book_keywords,ip_add)
		values ('$book_cat',NOW(),'$book_title','$book_author','$book_img1','$book_img2','$book_cost','$book_desc','$s_name','$s_phone','$book_keywords','$ip')";
